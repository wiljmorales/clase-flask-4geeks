...
class Thought:
  ...
  # @classmethod
  # def create(cls, content, tags):
  #   new_thought = cls(content, tags) 
  #   cls.all_thoughts.append(new_thought)
  #   return new_thought
  def serialize(self):
    return {
      "id": self.id,
...
def handle_thoughts():
  ...
  if request.method == "GET":
    return jsonify([thought.serialize() for thought in Thought.all_thoughts])
  else:
    body = request.json
    new_thought = Thought(body["content"], body["tags"])
